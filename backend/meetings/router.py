...
def get_dashboard_meetings(
    ...
    for meeting in all_meetings:
        ...
        grouped[date_key].append({
            ...
            "owner_name": meeting.owner.name if meeting.owner and meeting.owner.name else None,
            "owner_email": meeting.owner.email if meeting.owner and meeting.owner.email else None,
            "meeting_type": meeting.meeting_type,
            "can_delete": bool(meeting.meeting_type == "regular" and meeting.owner_id == current_user.id),
            "room_id": meeting.room_id,
